      ...
      <div className="container">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <p className="pb-4">
            ...
            relaxed cocktail reception, you can expect nothing short of fresh
            and flavorful.
          </p>
          <Button
            onClick={() => {
        ...
        <div className="flex flex-row flex-wrap items-center justify-center gap-8 py-20 lg:gap-24">
          <div className="max-w-screen-sm">
            ...
            <p className="pb-4">
              No matter the event, we have the menu for it. We love cocktail
              hours outfitted with stellar charcuterie displays and raw bars as
              much as well love pizza and burgers as midnight snacks. We offer
              an inventive kitchen and bar menu you can tailor to your tastes,
              so your event will look (and taste) exactly how you envision.
            </p>
            <Button
              onClick={() => {
                onOpen();
        ...
        <div className="flex flex-col lg:relative">
          ...
          <div className="z-10 max-w-full bg-card p-4 text-center lg:absolute lg:left-[60%] lg:top-[60%] lg:-translate-y-1/2 lg:p-14 lg:text-start">
            ...
            <p className="pb-4">
              ...
              in our kitchen works to ensure the freshest ingredients are used
              to make innovative ideas come to life on the plate. The team
              prioritizes not only stellar taste, but also visual impact, making
              every meal a masterpiece. It must be a work of art before it
              leaves our kitchen.
            </p>
            <Button
              onClick={() => {
        ...
        <div className="flex flex-row flex-wrap items-center justify-center gap-8 pt-20 lg:gap-24">
          <figure className="max-h-[600px] max-w-[400px]">
            <Image
          ...
          <div className="max-w-screen-sm text-center">
            ...
            <p className="pb-4 text-center">
              ...
              compliments that it was the best wedding food they ever had (and
              we agreed)! The service was fast and friendly and the food was
              fantastic. Overall the entire experience blew my expectations for
              the whole “planning a wedding process” out of the water and you
              are crazy if you don’t check this place out. Hoping we have some
              friends chose the same venue so we can go back!
            </p>
          </div>
        </div>
      </div>
